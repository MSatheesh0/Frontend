...
class QrCard extends StatelessWidget {
  ...
  void _copyProfileId(BuildContext context) {
    Clipboard.setData(ClipboardData(text: profile.codeId));
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Copied ${profile.codeId} to clipboard'),
          ...
          children: [
            ...
            Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(AppConstants.radiusMd),
                child: Image.network(
                  'https://quickchart.io/qr?text=${Uri.encodeComponent(profile.codeId)}&size=220',
                  fit: BoxFit.cover,
