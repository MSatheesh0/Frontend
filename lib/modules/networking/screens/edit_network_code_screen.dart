          ...
          child: Column(
            ...
            children: [
              ...
              FutureBuilder<List<Map<String, dynamic>>>(
                future: NetworkingService().getNetworkCodeMembers(
                  widget.networkCode['id']?.toString() ?? widget.networkCode['_id']?.toString() ?? ''
                ),
                builder: (context, snapshot) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final memberName = member['name']?.toString() ?? 'Unknown User';
                      final headline = member['headline']?.toString() ?? 'No headline';
